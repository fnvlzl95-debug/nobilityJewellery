...
const faqItems = [
  {
    "question": "585 각인은 무슨 뜻인가요?",
    "answer": "585는 합금 1,000부분 가운데 금이 585부분, 즉 58.5%라는 뜻으로 쓰이며 보통 14K 표기와 연결해 읽습니다. 다만 숫자만으로 제품 전체의 진위와 실제 함량을 확정할 수는 없습니다."
  },
  {
    "question": "750 각인은 18K와 같은 뜻인가요?",
    "answer": "750은 금 함량 75.0%를 뜻하고 18K는 24를 기준으로 금 24분의 18을 나타내므로 대응하는 기준으로 읽을 수 있습니다. 제품의 판매 서류와 보증 내용도 함께 확인하세요."
  },
  {
    "question": "925라고 적혀 있으면 순은인가요?",
    "answer": "925는 일반적으로 은 92.5% 합금을 뜻하며 스털링 실버 표기에서 사용됩니다. 높은 품위의 은을 뜻하는 숫자와는 구분해야 하며, 각인만으로 진위를 확정할 수 없습니다."
  },
  {
    "question": "Pt950은 무엇을 의미하나요?",
    "answer": "Pt950은 합금 1,000부분 중 백금이 950부분, 즉 95.0%라는 뜻의 표기로 사용됩니다. 제품 설명과 보증서를 함께 확인해 중심 금속을 대조하세요."
  },
  {
    "question": "각인이 있으면 진품으로 봐도 되나요?",
    "answer": "아닙니다. 각인은 소재 확인의 단서일 뿐 진위 보증서가 아닙니다. 판매 서류와 부품별 표기를 대조하고, 필요한 경우 전문 실물 검사 가능 범위를 문의하세요."
  }
]

const quickAnswers = [
  "585는 합금 1,000부분 가운데 금이 585부분이라는 뜻으로 쓰이며, 보통 14K 표기와 연결해 읽습니다.",
  "750은 금 75.0%, 925는 은 92.5%, Pt950은 백금 95.0%를 뜻하는 표기로 사용됩니다.",
  "각인은 소재를 확인하는 단서일 뿐입니다. 판매 서류·부품별 표기·전문 실물 확인 없이 진위나 전체 소재를 확정하지 마세요."
]

const sections = [
  {
    "title": "대표 귀금속 각인 숫자 한눈에 읽기",
    "paragraphs": [
    ...
    "image": {
      "src": "/Image/guide/jewelry-hallmark-numbers-meaning-section-1.webp",
      "alt": "585·750·925·Pt950 각인을 비교하는 귀금속 표기 안내 이미지",
      "caption": "대표 숫자는 천분율과 K 표기를 함께 비교해 읽습니다."
    }
  },
  {
  ...
  },
  {
    ...
    "image": {
      "src": "/Image/guide/jewelry-hallmark-numbers-meaning-section-3.webp",
      "alt": "백금 반지와 금도금 주얼리의 각인과 표면층을 확대경으로 확인하는 모습",
      "caption": "표면 금층의 표기와 제품 전체 소재는 구분해서 확인해야 합니다."
    }
  },
  {
    "title": "각인으로 확정할 수 없는 것",
    "paragraphs": [
  ...
  },
  {
    ...
    "image": {
      "src": "/Image/guide/jewelry-hallmark-numbers-meaning-section-5.webp",
      "alt": "전문가가 확대경으로 반지 각인을 확인하고 보증서와 대조하는 모습",
      "caption": "중요한 거래나 수리 전에는 각인과 서류, 제품 전체 상태를 함께 확인합니다."
    }
  }
]

const cautions = [
  "국가별 귀금속 표기와 홀마크 제도는 적용 기준이 다를 수 있으므로 특정 국가의 법적 요건으로 일반화하지 마세요.",
  "585·750·925·Pt950이 선명하더라도 각인만으로 실제 순도와 진위를 보증할 수는 없습니다.",
...
const gmInquiryTopic = '귀금속 소재와 순도 확인'
const gmHeroAlt = '금·은·백금 주얼리의 순도 각인을 확대경으로 확인하는 모습'
const gmSourceNote = '금·은·플래티넘의 함량 표기와 금도금 제품 확인에 관한 내용은 아래 승인된 미국 연방거래위원회 소비자 안내 및 지침을 기준으로 정리했습니다. 국가별 홀마크와 도금 약어의 세부 요건은 제품이 판매된 관할의 설명과 서류를 함께 확인해야 합니다.'
const gmSources = [
  {
    "label": "미국 연방거래위원회(FTC) 소비자 안내: 플래티넘·금·은 주얼리 구매",
    "url": "https://consumer.ftc.gov/articles/buying-platinum-gold-and-silver-jewelry",
    "note": "금의 K 표기, 은 925, 플래티넘 함량 표기의 공식 소비자 안내"
  },
  {
    "label": "미국 연방거래위원회(FTC): Advertising Platinum Jewelry",
    "url": "https://www.ftc.gov/business-guidance/resources/advertising-platinum-jewelry",
    "note": "플래티넘 950, 900, 850 및 기타 합금 표기의 의미를 설명하는 공식 지침"
  }
]
