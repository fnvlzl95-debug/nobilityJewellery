...
const pagePath = '/guide/mother-necklace-production-time'
const pageTitle = '어머니 목걸이 제작 기간, 선물 날짜 맞추려면 | 귀족'
const pageDescription = '어머니 목걸이 제작 기간은 디자인, 길이, 펜던트 구성, 재고 여부에 따라 달라져요. 선물 일정 맞추는 방법을 정리했습니다.'
const ogImage = `${siteConfig.url}/Image/necklace/NC0201.webp`
  ...
  script: [
    {
      ...
      innerHTML: JSON.stringify(buildBreadcrumbJsonLd([
        ...
        { name: '어머니 목걸이 제작 기간', path: pagePath },
      ])),
    },
    {
      type: 'application/ld+json',
