...
export const galleryItems: GalleryItem[] = [
  {
    ...
    description: '14K 화이트골드, 로즈골드, 옐로우골드로 제작되는 프로미스 커플링입니다. 결혼반지, 커플링으로 인기 있으며 사이즈 맞춤 주문제작이 가능합니다. 종로 귀금속 도매가로 제공됩니다.',
  ...
  },
  {
    ...
    title: '순금 말띠 아기 반지',
    titleEn: 'Signet Ring',
    description: '24K 순금으로 제작된 말띠 아기 반지입니다. 돌잔치 선물, 백일 선물로 인기 있으며 말띠 해 태어난 아기를 위한 전통적인 순금 반지입니다. 사이즈 주문제작 가능합니다.',
    material: '순금',
    workType: '주문제작 가능',
    delivery: '1-2주',
  ...
  },
  {
    ...
    description: '14K 골드 체인 목걸이입니다. 심플하면서도 고급스러운 디자인으로 어떤 펜던트와도 잘 어울리며, 길이 조절이 가능해 다양한 스타일링이 가능합니다. 종로 도매가 제공.',
    material: '14K 골드',
    workType: '길이 조절 가능',
    delivery: '즉시',
  ...
  },
  {
    ...
    title: '순금 뱅글 브레이슬릿',
    titleEn: 'Gold Bangle',
    description: '24K 순금으로 제작된 뱅글 스타일 팔찌입니다. 순도 99.9% 순금의 묵직한 무게감과 광택이 특징이며, 사이즈 주문제작이 가능합니다. 종로 귀금속 도매 전문점에서 합리적인 가격에 제공합니다.',
    material: '24K 순금',
    workType: '사이즈 주문',
    delivery: '2-3주',
  ...
  },
  {
    ...
    description: '18K 골드로 제작된 웨딩 주얼리 컬렉션입니다. 결혼식을 위한 목걸이, 귀걸이, 반지 등을 맞춤 구성할 수 있으며, 신부의 드레스와 스타일에 맞춰 상담 후 제작해드립니다.',
    material: '18K 골드',
    workType: '맞춤 제작',
    delivery: '상담 후 결정',
