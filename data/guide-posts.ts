...
export const guidePosts: GuidePostSummary[] = [
  ...
  },
  {
    ...
    title: '목걸이 엉켰을 때 푸는 법: 당기지 말고 매듭 중심부터',
    description: '엉킨 목걸이는 양끝을 당기지 말고 잠금장치를 연 뒤 매듭 중심의 빈 공간부터 넓히세요. 가는 체인·펜던트·여러 목걸이 분리 순서와 작업을 멈출 손상 신호를 정리했습니다.',
  ...
  },
  {
    ...
    title: '가넷 종류 5가지와 색별 구분법｜빨강·주황·녹색 가넷 차이',
    description: '가넷은 한 종류가 아닙니다. 파이로프·알만다인·스페사르틴·그로슐러·안드라다이트와 로돌라이트·차보라이트·데만토이드를 색·종·변종 기준으로 구분합니다.',
    keyword: '가넷 종류',
  ...
  },
  {
    ...
    title: '오팔 종류별 차이: 블랙·화이트·볼더·파이어 오팔 구분',
    description: '오팔은 블랙·화이트·볼더·크리스털·파이어로 구분하지만 종류명만으로 품질이 정해지지는 않습니다. 바탕색·투명도·모암 구조·유색 효과를 비교하는 순서를 정리했습니다.',
    keyword: '오팔 종류',
  ...
  },
  {
    ...
    title: '반지 끼는 손가락 의미: 왼손·오른손별 위치와 선택 기준',
    description: '반지 위치 의미는 고정된 규칙이 아닙니다. 왼손 약지의 결혼·커플링 관습, 오른손 약지와 엄지·검지·중지·새끼손가락의 인상, 손가락별 호수 선택 기준을 정리합니다.',
  ...
  },
  {
    ...
    title: '다이아몬드 투명도 등급 11단계: FL·IF·VVS·VS·SI·I 뜻',
    description: '다이아몬드 투명도는 10배 확대에서 내포물과 표면 특징을 보는 기준입니다. FL부터 I3까지 11단계, 같은 등급도 달라지는 내포물 위치와 감정서 확인법을 정리합니다.',
  ...
  },
  {
    ...
    title: '결혼반지 가드링 고르는 법: 곡선·높이·호수 확인 기준',
    description: '결혼반지 가드링은 메인 반지의 세팅 높이와 옆면 곡률, 접촉 위치를 먼저 확인해야 합니다. 직선형·곡선형·V자형 차이와 겹침 착용 시 호수·전체 폭 점검법을 정리했습니다.',
    keyword: '결혼반지 가드링',
  ...
  },
  {
    ...
    description: '다이아몬드 컷 종류를 라운드, 오벌, 쿠션, 페어, 에메랄드, 프린세스, 마퀴즈로 비교하고 모양·비율·컷 등급 선택 기준을 안내합니다.',
    keyword: '다이아몬드 컷 종류',
  ...
  },
  {
    ...
    title: '다이아 반지 세팅 종류｜프롱·베젤·파베·채널, 예물 선택 기준',
    description: '다이아 반지 세팅은 반짝임, 걸림, 안정성, 관리 편의성을 함께 비교해야 합니다. 프롱·베젤·파베·채널 차이와 예물 반지 상담 전 확인할 항목을 정리했습니다.',
  ...
  },
  {
    ...
    title: '반지 금속 알레르기: 니켈·합금·도금 확인 전 체크리스트',
    description: '반지 착용 뒤 가려움이나 발진이 반복될 때 니켈 등 금속 접촉 가능성을 단정 없이 살펴봅니다. 실제 합금·도금 사양 확인법과 착용 중단·의료 상담 기준을 정리했습니다.',
    keyword: '반지 금속 알레르기',
  ...
  },
  {
    ...
    title: '큐빅·모이사나이트·다이아 차이: 예물 반지 비교 기준',
    description: '큐빅(CZ)·모이사나이트·다이아몬드는 재료와 제품 표기가 다릅니다. 예산·착용 목적·세팅 조건·감정 문서 필요 여부를 같은 기준으로 비교하세요.',
  ...
  },
  {
    ...
    title: '돌반지 각인 비용｜글자 수·위치·작업 방식 확인',
    description: '돌반지 각인 비용은 글자 수, 각인 위치, 기성 제품 추가 작업인지 주문제작인지에 따라 달라질 수 있습니다. 문구·수령 희망일·제품 상태를 상담 전에 확인하세요.',
    keyword: '돌반지 각인 비용',
  ...
  },
  {
    ...
    description: '어머니 목걸이 제작 기간은 디자인, 길이, 펜던트 구성, 재고 여부에 따라 달라져요. 선물 일정 맞추는 방법을 정리했습니다.',
  ...
  },
  {
    ...
    title: '돌반지 주문제작 기간 최소 2주｜수령일 맞추는 확인 순서',
    description: '돌반지 주문제작은 최소 2주가 필요합니다. 디자인·각인·검수와 수령 방법을 확인하고 희망 수령일에 맞춰 상담하세요.',
    keyword: '돌반지 주문제작 기간',
